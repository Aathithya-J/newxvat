...
import "./Quiz.css";
import { Upload as UploadIcon, FileText, X, CheckCircle, FolderOpen, Send } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex-1">
              {(!file || status === "success") && (
                <div 
                  className="bg-gray-800 rounded-xl border border-gray-700 p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-700 transition-colors h-full min-h-[400px]"
